...
# Descripción
Este programa permite encontrar la ruta más corta entre distintas ciudades de Japón utilizando el algoritmo de Dijkstra.
...
El archivo `mate_discreta.py` esta organizado en bloques:

- **Bloque 1 - Datos del grafo**: diccionario de adyacencia con las 15 ciudades de Japon y sus conexiones.
- **Bloque 2 - Funciones del algoritmo**: implementacion manual de Dijkstra.
- **Bloque 3 - Funciones de visualizacion**: dibujo del grafo con networkx y matplotlib.
- **Bloque 4 - Funciones de interfaz**: logica que conecta los botones y combobox con el algoritmo.
- **Bloque 5 - Ventana principal**: creacion de la ventana de Tkinter y sus widgets.
